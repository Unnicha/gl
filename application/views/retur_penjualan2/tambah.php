					...
					<div class="col-lg">
						...
						<div class="form-row mb-3">
							...
							<div class="col">
								...
								<input type="text" name="faktur_retur" id="faktur_retur" data-target="#err-faktur_retur" class="form-control" placeholder="Masukkan faktur retur jual" value="<?= set_value('faktur_retur') ?>" required>
