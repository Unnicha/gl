						...
						<div class="form-group row">
							<div class="col">
								...
								<div class="input-group">
									...
									<input type="text" name="tanggal" id="tanggal" data-target="#err-tanggal" class="form-control datepicker" min="<?=$min_date?>" value="<?= $transaksi['tanggal_transaksi'] ?>" autocomplete="off" required>
								</div>
