					...
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<select name="supplier" id="supplier" data-target="#err-supplier" class="form-control selectpicker" required>
									<option value="<?=$transaksi['kode_supplier']?>" selected><?= $transaksi['kode_supplier'].' - '.$transaksi['nama_supplier'] ?></option>
								</select>
						...
						<div class="form-group row">
							<div class="col">
								...
								<select name="faktur_beli" id="faktur_beli" data-target="#err-faktur_beli" class="form-control selectpicker" required>
									<option value="<?=$transaksi['faktur_beli']?>" selected><?= $transaksi['faktur_beli'] ?></option>
								</select>
						...
						<div class="form-row mb-3">
							...
							<div class="col">
								...
								<input type="text" name="faktur_retur" id="faktur_retur" data-target="#err-faktur_retur" class="form-control" placeholder="Masukkan faktur retur beli" value="<?= $transaksi['faktur_retur_beli'] ?>" required>
						...
						<div class="form-row mb-3">
							...
							<div class="col">
								...
								<div class="input-group">
									...
									<input type="text" name="jatuh_tempo_giro" id="jatuh_tempo_giro" data-target="#err-jatuh_tempo_giro" min="<?= $min_date ?>" class="form-control datepicker" value="<?= $transaksi['jatuh_tempo_giro'] ?>" autocomplete="off">
								</div>
