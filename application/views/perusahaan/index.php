<div class="content container-fluid">
	...
	<div class="row">
		...
		<div class="col-sm-auto">
			<a href="<?= base_url() ?>perusahaan/tambah" class="btn btn-primary text-right">
		...
		<div class="card shadow">
			<div class="card-header">
				<ul class="nav nav-tabs card-header-tabs" id="myTabs">
					<a class="nav-link active" href="<?= base_url() ?>perusahaan">Data Perusahaan</a>
					<a class="nav-link" href="<?= base_url() ?>setup_perusahaan">Setup Perusahaan</a>
				</ul>
			</div>
...
<script> 
	$(document).ready(function () {
		...
		$('#myTable').on('click', '.btn-detail', function() {
			$.ajax({
				type	: 'POST',
				url		: '<?= base_url() ?>perusahaan/detail',
				data	: {
					'id' : $(this).data('id'),
				},
