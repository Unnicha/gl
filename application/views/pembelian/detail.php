<div class="modal-header px-4">
	...
	<div class="">
		<a href="<?= base_url('pembelian/edit/'.$transaksi['kode_transaksi']) ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="Ubah">
			...
			<div class="col-xl">
				<table class="table table-detail-border">
					<tbody>
						...
						<tr>
							<td scope="row" class="title">Faktur Beli</td>
