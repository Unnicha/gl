					...
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<select class="form-control selectpicker" name="supplier" id="supplier" data-target="#err-supplier" data-as="Supplier" data-live-search="true" data-size="5" required>
						...
						<div class="form-row mb-3">
							...
							<div class="col">
								...
								<input type="text" class="form-control" name="faktur_beli" id="faktur_beli" data-target="#err-faktur_beli" data-as="Faktur Jual" placeholder="Masukkan faktur beli" value="<?= set_value('faktur_beli'); ?>" oninput="autoUppercase(this)" required unique>
