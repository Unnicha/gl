<div class="content container-fluid">
	<div class="row content-title">
		...
		<div class="col-sm-auto">
			<a href="<?= base_url() ?>utang" class="close">
	...
	<form id="myForm" name="myForm" action="" method="post" novalidate>
						...
						<div class="form-group row">
							<div class="col">
								...
								<select name="supplier" id="supplier" data-target="#err-supplier" class="form-control selectpicker" data-live-search="true" data-size="5" required>
									...
									<?php $pilih = (set_value('supplier') == $p['kode_supplier']) ? 'selected' : '' ?>
		...
		<div class="card mb-4">
			<div class="card-body">
				...
				<!-- Table Utang -->
				<table id="table-utang" class="table table-detail table-bordered table-striped table-responsive-lg mb-0">
					<thead>
						<tr>
							<th>No. Invoice</th>
							<th>Tanggal</th>
		...
		<div class="row">
			<div class="col">
				...
				<a href="<?= base_url('utang') ?>" class="btn btn-secondary">
...
<script type="text/javascript" src="<?= base_url('asset/js/form/utang.js') ?>"></script>
