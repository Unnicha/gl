					...
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<select class="form-control selectpicker" name="pelanggan" id="pelanggan" data-target="#err-pelanggan" data-live-search="true" data-size="5" required>
									<option value="">Pilih Pelanggan</option>
									<?php foreach($pelanggan as $p) : ?>
									<?php $pilih = ($transaksi['pelanggan'] == $p['kode_pelanggan']) ? 'selected' : '' ?>
						...
						<div class="form-row mb-3">
							...
							<div class="col">
								...
								<input type="text" class="form-control" name="faktur_jual" id="faktur_jual" data-target="#err-faktur_jual" placeholder="Masukkan faktur jual" value="<?= $transaksi['faktur_jual'] ?>" required>
