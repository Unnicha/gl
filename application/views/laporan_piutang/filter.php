...
<?php $filter = $this->session->userdata('laporan_piutang') ?>
...
<div class="modal-body">
	<div class="row mb-3" id="formDisplay">
		<div class="col p-0">
			<div class="form-group row">
				<div class="col">
					...
					<select name="jenis_laporan" id="jenis_laporan" data-err="#err-jenis_laporan" class="form-control selectpicker">
						...
						<option value="piutang" <?= $filter['jenis_laporan'] == 'piutang' ? 'selected' : ''; ?>>
							Laporan Piutang
						</option>
			...
			<div class="form-group row">
				<div class="col">
					<label class="label-bold" for="akun_asal">Akun Piutang</label>
...
<script>
	...
	function tampilkan() {
		...
		if (tampil) {
			...
			$.ajax({
				type	: 'POST',
				url		: '<?= base_url() ?>laporan_piutang/display',
				data	: {
					'id' : id,
					'value' : value,
				},
