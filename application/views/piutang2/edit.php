						...
						<div class="form-group row">
							<div class="col">
								...
								<div class="input-group">
									...
									<input type="text" name="tanggal" id="tanggal" data-target="#err-tanggal" class="form-control datepicker" placeholder="Masukkan Tanggal" value="<?= $pembayaran['tanggal_transaksi'] ?>" autocomplete="off" readonly required>
								</div>
