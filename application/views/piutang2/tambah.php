<div class="content container-fluid">
	...
	<form id="myForm" name="myForm" action="" method="post" novalidate>
		...
		<!-- <input type="hidden" name="akun_ppn" id="akun_ppn" value="<?=$akun_ppn?>"> -->
			...
			<div class="card-body">
				<div class="row row-card">
					...
					<div class="col-lg">
								...
								<div class="form-row">
									...
									<div class="col-sm">
										<div class="input-group">
											...
											<input type="text" name="konversi" id="konversi" data-target="#err-konversi" class="form-control mask_money" placeholder="Masukkan nilai konversi" value="<?= set_value('konversi') ?>" required>
										</div>
						...
						<div class="form-group row">
							<div class="col">
								<label class="label-bold">Total Dibayar</label>
								<input type="text" name="total_bayar" id="total_bayar" data-target="#err-total_bayar" class="form-control mask_money" value="<?= set_value('total_bayar') ?>" autocomplete="off" required>
								<p class="mb-0" id="err-total_bayar"></p>
							</div>
						</div>
					</div>
					<!-- col-lg -->
