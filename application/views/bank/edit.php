	...
	<form action="" method="post">
			...
			<div class="card-body px-4">
				<div class="row" style="margin-bottom: -15px;">
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<input type="text" class="form-control" name="no_voucher" id="no_voucher" placeholder="Masukkan no. voucher" value="<?= set_value('no_voucher') ? set_value('no_voucher') : $transaksi['no_voucher'] ?>">
						...
						<div class="form-group row">
							<div class="col-lg">
								...
								<input type="text" class="form-control" name="no_giro" id="no_giro" placeholder="Masukkan no. giro" value="<?= set_value('no_giro') ? set_value('no_giro') : $transaksi['no_giro'] ?>">
								<?= form_error('no_giro') ?>
							</div>
							...
							<div class="col-lg">
								...
								<div class="input-group">
									<input type="text" class="form-control datepicker" name="jatuh_tempo" id="jatuh_tempo" min="<?=$min_date?>" value="<?= set_value('jatuh_tempo') ? set_value('jatuh_tempo') : $transaksi['jatuh_tempo_giro'] ?>" placeholder="Masukkan tanggal" autocomplete="off" readonly>
									<div class="input-group-append btn-date">
										<span class="input-group-text">
											<i class="bi bi-calendar icon-small"></i>
										</span>
								...
								<div class="form-row">
									...
									<div class="col">
										<div class="input-group">
											...
											<input type="text" class="form-control mask_money" name="konversi" id="konversi" value="<?= $transaksi['konversi'] ?>" numeric="numeric" required>
										</div>
										<?= form_error('konversi') ?>
									</div>
								</div>
					...
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control mask_money" name="jumlah" id="jumlah" placeholder="Masukkan jumlah transaksi" value="<?= set_value('jumlah') ? set_value('jumlah') : $transaksi['jumlah'] ?>" required>
								</div>
								<?= form_error('jumlah') ?>
							</div>
						</div>
						...
						<div class="form-group row">
							<div class="col">
								<label class="label-bold" for="keterangan">Keterangan</label>
		...
		<div class="row mt-4">
			<div class="col">
				...
				<a href="<?= base_url() ?>bank" class="btn btn-secondary">
...
<script type="text/javascript" src="<?= base_url() ?>asset/js/form/serba_serbi.js"></script>
