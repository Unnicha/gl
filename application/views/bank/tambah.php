					...
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<input type="text" class="form-control" name="no_voucher" id="no_voucher" placeholder="Masukkan no. voucher" value="<?= set_value('no_voucher') ?>">
						...
						<div class="form-group row">
							<div class="col-lg">
								...
								<input type="text" class="form-control" name="no_giro" id="no_giro" placeholder="Masukkan no. giro" value="<?= set_value('no_giro') ?>">
								<?= form_error('no_giro') ?>
							</div>
							...
							<div class="col-lg">
								...
								<div class="input-group">
									<input type="text" class="form-control datepicker" name="jatuh_tempo" id="jatuh_tempo" min="<?=$min_date?>" value="<?= set_value('jatuh_tempo') ?>" placeholder="Masukkan tanggal" autocomplete="off" readonly>
									<div class="input-group-append btn-date">
										<span class="input-group-text">
											<i class="bi bi-calendar icon-small"></i>
										</span>
...
<script type="text/javascript" src="<?= base_url() ?>asset/js/form/bank.js"></script>
<script>
	konversi()
</script> 
