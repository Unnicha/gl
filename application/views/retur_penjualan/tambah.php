...
<div class="content container-fluid">
	...
	<form id="myForm" action="" method="post" novalidate>
		<input type="hidden" name="penjualan" id="penjualan" value="<?=$penjualan?>">
					...
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<select name="pelanggan" id="pelanggan" data-target="#err-pelanggan" class="form-control selectpicker" data-live-search="true" data-size="5" required>
									<option value="">Pilih Pelanggan</option>
									<?php foreach($pelanggan as $p) : ?>
									<?php $value = (set_value('pelanggan')) ? set_value('pelanggan') : $penjualan['pelanggan'] ?>
									<?php $pilih = ($value == $p['kode_pelanggan']) ? 'selected' : '' ?>
						...
						<div class="form-group row">
							<div class="col">
								...
								<select name="faktur_jual" id="faktur_jual" data-target="#err-faktur_jual" class="form-control selectpicker" data-live-search="true" data-size="5" required>
						...
						<div class="form-group row">
							<div class="col">
								...
								<div class="input-group">
									...
									<input type="text" name="tanggal" id="tanggal" data-target="#err-tanggal" class="form-control datepicker" min="<?=$min_date?>" max="<?=$max_date?>" placeholder="dd/mm/yyyy" value="<?= set_value('tanggal') ?>" autocomplete="off" required>
								</div>
						...
						<div class="form-row mb-3">
							...
							<div class="col">
								...
								<input type="text" name="faktur_retur" id="faktur_retur" data-target="#err-faktur_retur" class="form-control" placeholder="Masukkan faktur retur jual" value="<?= set_value('faktur_retur') ?>" oninput="autoUppercase(this)" required unique>
