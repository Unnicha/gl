...
<div class="content container-fluid">
	<div class="row content-title">
		...
		<div class="col-sm-auto">
			<a href="<?= base_url() ?>retur_penjualan" class="close">
	...
	<form id="myForm" action="" method="post" novalidate>
		...
		<input type="hidden" name="akun_ppn" id="akun_ppn" value="<?= $transaksi['akun_ppn'] ?>">
			...
			<div class="card-body">
				<div class="row" style="margin-bottom: -.9rem;">
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<select name="pelanggan" id="pelanggan" data-target="#err-pelanggan" class="form-control selectpicker" required>
									<option value="<?=$transaksi['kode_pelanggan']?>" selected><?= $transaksi['kode_pelanggan'].' - '.$transaksi['nama_pelanggan'] ?></option>
								</select>
						...
						<div class="form-group row">
							<div class="col">
								<label class="label-bold">Faktur Penjualan</label>
								<select name="faktur_jual" id="faktur_jual" data-target="#err-faktur_jual" class="form-control selectpicker" required>
									<option value="<?=$transaksi['faktur_jual']?>" selected><?= $transaksi['faktur_jual'] ?></option>
								</select>
						...
						<div class="form-group row">
							<div class="col">
								...
								<div class="input-group">
									...
									<input type="text" name="tanggal" id="tanggal" data-target="#err-tanggal" class="form-control datepicker" min="<?=$min_date?>" max="<?=$max_date?>" value="<?= $transaksi['tanggal_transaksi'] ?>" autocomplete="off" required>
								</div>
						...
						<div class="form-row mb-3">
							<!-- input Faktur Retur Jual -->
							<div class="col">
								<label class="label-bold">Faktur Retur Jual</label>
								<input type="text" name="faktur_retur" id="faktur_retur" data-target="#err-faktur_retur" class="form-control" placeholder="Masukkan faktur retur jual" value="<?= $transaksi['faktur_retur_jual'] ?>" required>
							...
							<div class="col">
								...
								<input type="text" name="surat_jalan" id="surat_jalan" data-target="#err-surat_jalan" class="form-control" placeholder="Masukkan surat jalan" value="<?= $transaksi['surat_jalan'] ?>">
						...
						<div class="form-row mb-3">
							<div class="col">
								...
								<input type="text" name="no_giro" id="no_giro" data-target="#err-no_giro" class="form-control" placeholder="Masukkan No. Giro" value="<?= $transaksi['no_giro'] ?>">
							...
							<div class="col">
								...
								<div class="input-group">
									...
									<input type="text" name="jatuh_tempo_giro" id="jatuh_tempo_giro" data-target="#err-jatuh_tempo_giro" class="form-control datepicker" min="<?=$min_date?>" value="<?= $transaksi['jatuh_tempo_giro'] ?>" autocomplete="off">
								</div>
					...
					<div class="col-lg">
						...
						<div class="form-group row">
							<div class="col">
								...
								<select name="akun_asal" id="akun_asal" data-target="#err-akun_asal" class="form-control selectpicker" data-live-search="true" data-size="5" required>
									...
									<?php $pilih = ($transaksi['akun_asal'] == $a['kode_akun']) ? 'selected' : '' ?>
						...
						<div class="form-group row">
							<div class="col">
								...
								<select name="akun_lawan" id="akun_lawan" data-target="#err-akun_lawan" class="form-control selectpicker" data-live-search="true" data-size="5" required>
									...
									<?php $pilih = ($transaksi['akun_lawan'] == $l['kode_akun']) ? 'selected' : '' ?>
								...
								<div class="form-row">
									...
									<div class="col-sm-auto">
										<select class="form-control" name="mata_uang" id="mata_uang" data-target="#err-mata_uang" required>
											...
											<?php $pilih = ($m['kode_mu'] == $transaksi['mata_uang']) ? 'selected' : ''; ?>
									...
									<div class="col-sm">
										<div class="input-group">
											...
											<input type="text" class="form-control mask_money" name="konversi" id="konversi" data-target="#err-konversi" placeholder="Masukkan nilai konversi" value="<?= $transaksi['konversi'] ?>" readonly required>
										</div>
						...
						<div class="form-group row">
							<div class="col">
								...
								<textarea name="keterangan" id="keterangan" data-target="#err-keterangan" class="form-control" placeholder="Masukkan Keterangan"><?= $transaksi['ket_transaksi'] ?></textarea>
			...
			<div class="card">
				<div class="card-body">
					<div class="form-row">
						<!-- Input PPN -->
						<div class="col">
							<label class="label-bold">Jenis PPN</label>
							<input type="text" class="form-control font-small" name="jenis_ppn" id="jenis_ppn" data-target="#err-jenis_ppn" placeholder="Jenis PPN" value="<?= $transaksi['jenis_ppn'] ?>" readonly required>
							<p class="mb-0" id="err-jenis_ppn"></p>
						</div>
						
						<!-- input besar PPN -->
						<div class="col">
							<label class="label-bold">Besar PPN</label>
							<div class="input-group">
								<input type="number" class="form-control font-small" name="besar_ppn" id="besar_ppn" data-target="#err-besar_ppn" min="1" max="100" placeholder="Besar PPN" value="<?= $transaksi['besar_ppn'] ?>" readonly required>
		...
		<div class="row">
			<div class="col">
				...
				<a href="<?= base_url('retur_penjualan') ?>" class="btn btn-secondary">
...
<script type="text/javascript" src="<?= base_url('asset/js/form/retur_penjualan.js') ?>"></script>
