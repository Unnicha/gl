					...
					<div class="col-lg">
						...
						<div class="form-row mb-3">
							...
							<div class="col">
								...
								<input type="text" class="form-control" name="faktur_jual" id="faktur_jual" data-target="#err-faktur_jual" data-as="Faktur Jual" placeholder="Masukkan faktur jual" value="<?= set_value('faktur_jual'); ?>" oninput="autoUppercase(this)" required unique>
