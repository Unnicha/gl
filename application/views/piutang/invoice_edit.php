...
<div class="modal-body">
	<form action="" method="post" name="formProduk">
		...
		<div class="form-group row">
			...
			<div class="col-lg">
				<input type="text" class="form-control" id="invoice" name="invoice" value="<?= $penjualan['faktur_jual'] ?>" readonly>
		...
		<div class="form-group row">
			...
			<div class="col-lg">
				<div class="input-group">
					...
					<input type="text" class="form-control" id="tgl_jual" name="tgl_jual" value="<?= $penjualan['tanggal_transaksi'] ?>" readonly>
				</div>
				<small class="text-danger" id="err-tgl_jual"></small>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg">
				<div class="input-group">
					...
					<input type="text" class="form-control" id="jatuh_tempo" name="jatuh_tempo" value="<?= $penjualan['jatuh_tempo'] ?>" readonly>
				</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg">
				<div class="input-group">
					...
					<input type="text" class="form-control mask_money" id="tagihan" name="tagihan" value="<?= $penjualan['total_tagihan'] ?>" readonly>
				</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg">
				<div class="input-group">
					...
					<input type="text" class="form-control mask_money" id="sisa" name="sisa" value="<?= $penjualan['sisa_tagihan'] ?>" readonly>
				</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg">
				<div class="input-group">
					...
					<input type="text" class="form-control mask_money" id="bayar" name="bayar" value="<?= $penjualan['jumlah_dibayar'] ?>">
				</div>
...
<div class="d-none" id="formAction">updatePiutang</div>
