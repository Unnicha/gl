...
<div class="modal-body">
	<form action="" method="post">
		...
		<div class="form-group row">
			<label class="col-form-label col-lg-3" for="produk">Produk</label>
			<div class="col-lg">
		...
		<div class="form-group row">
			...
			<div class="col-lg">
				<div class="input-group">
					...
					<input type="text" class="form-control mask_money" id="harga" name="harga" placeholder="Masukkan harga produk" value="<?=$produk['harga']?>">
				</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg">
				<input type="text" class="form-control mask_money" id="diskon" name="diskon" placeholder="Masukkan diskon per item" value="<?=$produk['diskon']?>">
